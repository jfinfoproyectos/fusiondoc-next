...
FusionDoc-Next utiliza internamente la potente biblioteca [**Iconify**](https://iconify.design/). A diferencia de las librerías tradicionales de iconos (que obligan a instalar pesados paquetes npm completos), Iconify es un motor dinámico que te da acceso a más de **200,000 íconos** provenientes de más de 150 colecciones de diseño (Material Design, Tabler, Lucide, Logos, etc.) descargándolos bajo demanda.
